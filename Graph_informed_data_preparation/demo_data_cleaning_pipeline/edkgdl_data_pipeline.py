...
TARGET_FILE = "../qualitative_data_for_modeling/event_7-abortion_finger"  # Change this to your file prefix
DATA_FILE = "event_7-abortion_finger"
...
def output_path(suffix: str) -> Path:
    ...
    return BASE_DIR / f"{DATA_FILE}{suffix}"
